...
const workflowNodeWritePublicSchema = z
	.object({
...
const sharedWorkflowWritePublicSchema = z
	.object({
...
export const workflowWritePublicShape = {
	...
	nodes: z.array(workflowNodeWritePublicSchema).openapi(workflowCreateFieldDocs.nodes),
	connections: z
		.custom<IConnections>(
	...
	settings: workflowSettingsWritePublicSchema,
	nodeGroups: z
		.array(workflowNodeGroupWritePublicSchema)
		.optional()
	...
	shared: z
		.array(sharedWorkflowWritePublicSchema)
		.optional()
