...
set "NODES_EXCLUDE=[]"
set "N8N_CODEX_CODING_REPOSITORIES=[{"id":"talent-ai","label":"Talent-AI","path":"%TALENT_AI_ROOT%","prepareSteps":[{"id":"offline-install","file":"node.exe","args":["%PNPM_JS%","install","--offline","--frozen-lockfile","--ignore-scripts"],"cwd":"upstream/n8n"}],"verificationProfiles":{"codex-node-targeted":[{"id":"codex-node-tests","file":"node.exe","args":["%PNPM_JS%","--filter","n8n-nodes-base","test","CodexCodingAgent"],"cwd":"upstream/n8n"},{"id":"nodes-base-typecheck","file":"node.exe","args":["%PNPM_JS%","--filter","n8n-nodes-base","typecheck"],"cwd":"upstream/n8n"}],"codex-runs-sidebar-targeted":[{"id":"codex-runs-cli-unit-tests","file":"node.exe","args":["%PNPM_JS%","--filter","n8n","test:win","codex-coding.controller","codex-runs-overview"],"cwd":"upstream/n8n"},{"id":"codex-runs-cli-sqlite-tests","file":"node.exe","args":["%PNPM_JS%","--filter","n8n","test:sqlite:win","codex-runs-overview"],"cwd":"upstream/n8n"},{"id":"cli-typecheck","file":"node.exe","args":["%PNPM_JS%","--filter","n8n","typecheck"],"cwd":"upstream/n8n"},{"id":"codex-runs-editor-tests","file":"node.exe","args":["%PNPM_JS%","--filter","n8n-editor-ui","test","codex-runs-overview","module.descriptor"],"cwd":"upstream/n8n"},{"id":"editor-ui-typecheck","file":"node.exe","args":["%PNPM_JS%","--filter","n8n-editor-ui","typecheck"],"cwd":"upstream/n8n"}],"codex-demo-fast":[{"id":"git-diff-check","file":"git.exe","args":["diff","--check"],"cwd":"."}]}}]"
